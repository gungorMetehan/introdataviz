...
```{r raincloud, fig.cap="Raincloud plot. The point and line in the centre of each cloud represent its mean and 95% CI. The rain represents individual data points."}
rain_height <- .1
